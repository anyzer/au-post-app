...
case class Address(`type`: String, lines: List[String], suburb: Option[String], postcode: String, state: String, country: String)
...
case class Price(calculated_price: Double, calculated_gst: Double)
